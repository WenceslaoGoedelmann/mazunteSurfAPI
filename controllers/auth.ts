...
export const register =async (req:Request, res:Response):Promise<void> => {
    ...
    const {nombre,surname,age, email, password,cellphone,location,address, height,weight,experience}: IUser = req.body //desestructuramos la respuesta que viene en el body de la Request
    
    const usuario = new Usuario({nombre,surname,age, email, password,cellphone,location,address, height,weight,experience }) //creamos el nuevo usuario utilizando el esquema de usuario
