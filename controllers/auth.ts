...
export const register =async (req:Request, res:Response):Promise<void> => {
    ...
    const {nombre,surname,age, email, password,cellphone,location,address, height,weight,experience}: IUser = req.body 
    
    const usuario = new Usuario({nombre,surname,age, email, password,cellphone,location,address, height,weight,experience })
